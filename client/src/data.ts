...
export const MOCK_PLAYERS: Player[] = [
	...
	},
	{
		...
		teamId: 1,
		photo:
			'https://img-cdn.hltv.org/playerbodyshot/CgO3veixSYH5OMIePtwp1u.png?ixlib=java-2.1.0&w=400&s=1b5f0f326bf822540d59ae246c1b7e65',
		trophyIds: [101, 102],
...

	{
		...
		teamId: 3,
		photo:
			'https://img-cdn.hltv.org/playerbodyshot/aFuk-1yq3DatdhVa3kICms.png?ixlib=java-2.1.0&w=400&s=4a99190a6e6eabbfd799ec121c5f9c53',
		trophyIds: [],
		stats: MOCK_STATS.frozen,
	},
	{
		id: 12,
		nick: 'Twistzz',
		...
		teamId: 3,
		photo:
			'https://img-cdn.hltv.org/playerbodyshot/djeIpvmdjSQ_cOHzaomwxF.png?ixlib=java-2.1.0&w=400&s=db0b4311a3a465affa9da3e355cb78cb',
		trophyIds: [],
		stats: MOCK_STATS.twistzz,
	},
	{
		id: 13,
		nick: 'jcobbb',
		firstname: 'Jakub',
		surname: 'Pietruszewski',
		country: Country.Poland,
		dateOfBirth: '2004-01-27',
		teamId: 3,
		photo:
			'https://img-cdn.hltv.org/playerbodyshot/EEnQR7JP45ECDWPxft2zHF.png?ixlib=java-2.1.0&w=400&s=137010231f6f6b1db77e15f4235dea1f',
		trophyIds: [],
		stats: MOCK_STATS.jcobbb,
	},
	{
		id: 14,
		nick: 'JBOEN',
		...
		teamId: 3,
		photo:
			'https://img-cdn.hltv.org/playerbodyshot/7mXOiZDRcCfuVomUVCmGz_.png?ixlib=java-2.1.0&w=400&s=b75e34e067442fcadd34d366e2277bf3',
		trophyIds: [],
		stats: MOCK_STATS.jboen,
	},
	{
		id: 15,
		nick: 'Neityu',
		...
		teamId: 3,
		photo:
			'https://img-cdn.hltv.org/playerbodyshot/z7Jeal58NVuDymx4F5O9D6.png?ixlib=java-2.1.0&w=400&s=71798505ba638781aff02d77bef9c9e4',
		trophyIds: [],
		stats: MOCK_STATS.neityu,
	},
]
...
export const MOCK_TROPHIES: Trophy[] = [
	{
		...
		image:
			'https://upload.wikimedia.org/wikipedia/ru/thumb/4/4d/PGL_Major_Stockholm_2021.png/250px-PGL_Major_Stockholm_2021.png?utm_source=ru.wikipedia.org&utm_campaign=index&utm_content=thumbnail',
		team: MOCK_TEAMS[1],
		tournamentId: 501,
		teamId: 1,
		winnerIds: [1, 2],
	},
	{
		...
		image:
			'https://img-cdn.hltv.org/eventlogo/awaDsLUuCqka6Q54efjwK9.png?ixlib=java-2.1.0&s=ac3bb776581548ccd0c490651a37968d',
		team: MOCK_TEAMS[1],
		tournamentId: 502,
		teamId: 1,
		winnerIds: [2, 3],
